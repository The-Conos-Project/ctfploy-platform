...
def user_layout(content, active="home", toasts=None):
    return layout(content, "CTFploy", ([('home','/dashboard','Dashboard'),('users','/classes','My classes'),('terminal','/leaderboard','Leaderboard')], active, 'Student workspace'), toasts=toasts)
