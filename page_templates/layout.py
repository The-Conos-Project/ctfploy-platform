...
def admin_layout(content, active="home", toasts=None):
    return layout(content, "CTFploy Admin", ([('home','/admin','Overview'),('users','/admin/classes','Classes'),('boxes','/admin/challenges','Challenges'),('trophy','/admin/leaderboard','Leaderboard'),('users','/admin/users','Users'),('settings','/admin/settings','Settings')], active, 'Admin'), toasts=toasts)
