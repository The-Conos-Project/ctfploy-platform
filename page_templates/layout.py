        ...
        fetch('/api/labs').then(r=>r.json()).then(data=>{
            ...
            data.labs.forEach(lab=>{
                ...
                html+='<div class=\\'labs-menu-item\\'>'
                    ...
                    +'<div class=\\'small-text\\' style=\\"margin-top:4px;\\">ssh '+escape(lab.username)+'@'+escape(lab.host)+':'+lab.host_port+'</div>'
                    +'</div>'
