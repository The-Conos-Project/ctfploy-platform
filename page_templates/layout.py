...
def admin_layout(content, active="home"):
    return layout(content, "CTFploy Admin", ([('home','/admin','Overview'),('users','/admin/classes','Classes'),('boxes','/admin/challenges','Challenges'),('settings','/admin/update','Update')], active, 'Administrator'))


def user_layout(content, active="home"):
    return layout(content, "CTFploy", ([('home','/dashboard','Dashboard'),('users','/classes','My classes')], active, 'Student workspace'))
